...
def send_To_Record_JSON(nftName, maxNFTs, nftsPerBatch, save_path, enableRarity, enableLogic, logicFile, Aiz_Blender_NFT_Output):
   """
   ...
   NFTRecord_save_path = os.path.join(Aiz_Blender_NFT_Output, "NFTRecord.json")
